...
#WARNING:Modifiche da qui

import dbus
from os import setuid
from subprocess import call

#WARNING:Modifiche a qui
...
while (True):
    ...
    active = call(['/usr/share/python-support/timekpr/getscreen.py'])
    while(active):
        #logkpr('Screensaver is active, sleeping for %s seconds' % VAR['POLLTIME'])
        logkpr('Screensaver is active, sleeping for 15 seconds')
        sleep(15)
        active = call(['/usr/share/python-support/timekpr/getscreen.py'])
